...
namespace Wavelet_transform
{
	...
	void _calc_coefs(func _phi_0, func f, _func _f, double _step, int _m)
	{
		...
		for (int k = ProcRank*segment; k < (1 + ProcRank)*segment; ++k, a += _step)
		{
